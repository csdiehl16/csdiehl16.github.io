...
const projectRawData = [
    ...
    },
    {
        ...
        tag: ['Geospatial', 'Dashboards', 'Data journalism'],
        description: 'An interactive dashboard that displays real-time fire incident information and surrounding demographics, updated every 15 minutes.',
    ...
    },
    {
        ...
        description: 'An interactive map that tells the story of the Lahania wildire using smooth animations.',
    ...
    },
    {
        ...
        tag: ['Geospatial', 'Data journalism'],
        description: 'An interactive map visualization of major coral bleaching events.',
    ...
    },
    {
        ...
        languages: ['React.js', 'D3.js'],
        tag: ['Data journalism', 'Geospatial'],
        description: 'A series of interactive maps that explore a Forest Service plan to mitigate wildfire throughout the U.S.',
    ...
    },
    {
        ...
        languages: ['React.js'],
        tag: ['Web development'],
        description: "A scrollytelling experience highlighting AP's best climate photography.",
...

    {
        ...
        description: 'Interactive dashboard built for internal use at Washington D.C. Metropolitan Transit Authority. Visualizes smart card data.',
        otherImages: ['/wmata_1.png', '/wmata_2.png', '/wmata_3.png', '/wmata_4.png']
    },
    {
        ...
        languages: ['React.js'],
        tag: ['Dashboards'],
        description: 'Allows users to connect Spotify accounts and receive music reccomendations using the Spotify Web API.'
    },
    {
        ...
        languages: ['React.js'],
        tag: ['Data journalism'],
        description: 'Interactive, Javascript-based data visualization of recent protests in the United States'
    },
    {
        ...
        languages: ['React.js'],
        tag: ['Dashboards', 'Geospatial'],
        description: 'Dashboard for visualizing smart card data showing passenger journeys on Sound Transit in the Puget Sound region'
    },
    {
        name: 'Type Cast',
        ...
        tag: ['Web development'],
        description: 'Javascript application that creates a type heirarchy for use in documents and web design'
    },
    {
    ...
    },
    {
        ...
        description: 'A machine learning model that clusters transit stations in King Count based on ridership demographics.',
        languages: ['Python', 'R'],
        tag: ['Geospatial']
    },
    {
    ...
    },
    {
        ...
        description: 'Data visualization of the change in Google searches for common destinations before and after the pandemic.',
        languages: ['Python', 'R'],
        tag: []
    },
...
const ProjectList = forwardRef((props, ref) => {
    ...
    const projectsFiltered = props.filters === 'All' ? projectRawData : projectRawData.filter((p) => p.tag.includes(props.filters));
    ...
    return (
        <div className="fade-in" ref={ref}>
            ...
            <button onClick={() => setViewMore((p) => !p)} className={classes['see-more-button']}>
                <span>{viewMore ? 'Hide' : 'See more'} projects</span>
                <img className={classes[viewMore ? 'arrow-clicked' : '']} alt="arrow" height="24px" width="24px" src="./down-arrow.svg"></img>
            </button>
        </div>
    );
});
